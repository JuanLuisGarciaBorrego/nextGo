...
export default function SaveOrCancelButtons({cancel, isSubmitting}) {
    return (
        <div className="absolute inset-x-0 bottom-0 md:relative p-2 md:p-0 md:mt-8 md:pt-5 border-t border-gray-200">
